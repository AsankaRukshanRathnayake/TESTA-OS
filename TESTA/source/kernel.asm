;*****************start of the kernel code of TESTA OS***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to TESTA version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO TESTA ************', 0x00 
	...
	wel7 db ' version 1.0.0 of TESTA From A.R. Rathnayake - SE/2019/053', 0x00
	...
	strPrompt		db	"TESTA_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"TESTA", 0x00	;OS details
